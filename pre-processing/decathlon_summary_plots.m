...
fDir = uigetdir('D:\Decathlon Raw Data','Select parent directory containing experiment data');
save_dir = uigetdir('D:\Decathlon Raw Data','Select directory to save output figures');
exp_name = 'D2';
ID = [];
